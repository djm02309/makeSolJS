...
public class SolidityPrintVisitor extends SolidityBaseVisitor<String> {
...
//			if(ctx.getChildCount() == )
    ...
    @Override
    public String visitElementaryTypeNameExpression(SolidityParser.ElementaryTypeNameExpressionContext ctx) {
        return visit(ctx.elementaryTypeName());
    }
